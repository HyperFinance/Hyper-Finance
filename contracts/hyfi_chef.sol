...
contract MasterChef is Ownable {
    ...
    uint public constant blocksTwoWeek = 403200; // 14 * 24 * 60 * 20; 14days
    uint public constant initBlockReward = 48e18;
    ...
    constructor(address _sushi, uint256 _startBlock, address _devaddr) {
    ...
    function updatePool(uint256 _pid) public {
        ...
        sushi.mint(devaddr, sushiReward.div(5));
